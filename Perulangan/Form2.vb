Public Class Form2
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        hasil = ""
        banyakBaris = Convert.ToInt32(barisBox.Text)
        banyakKolom = (banyakBaris * 2) - 1
        If polaBox.Text = "Piramyd" Then
        ...
        ElseIf polaBox.Text = "Hollow Piramyd" Then
        ...
        ElseIf polaBox.Text = "Inverted Piramyd" Then
            ...
            Next
        ElseIf polaBox.Text = "Hollow Inverted Piramyd" Then
            batasAtas = banyakKolom
            batasBawah = 1
            For baris As Integer = 1 To banyakBaris
                kolom = 1
